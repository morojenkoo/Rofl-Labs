...
Тогда все правила убывают по $f_1$, кроме правила $aabbcc \rightarrow abcabc$ - в левой и правой части задействованы все буквы, поэтому по $f_1$ они равны

И тут в дело вступает $f_2$: сумма позиций с: 11 < 9

Перед $f_3$: сумма позиций b стоит коэффициент $(1/2)^{\text{len}(w)}$ - это как максимум 1/8, а то и меньше - оно играет роль только в T', для сравнения строк, которые равны по $f_1$ и $f_2$
